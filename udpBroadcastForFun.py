...
tempStrBo = '<?xml version="1.0" encoding="GB2312" standalone="yes" ?>\n<HvCmdRespond Ver="3.0">\n    <CmdName IP="172.19.254.%d" Mask="255.255.0.0" Gateway="172.19.99.99" MAC="0c:f4:05:12:ff:f%d" SN="VECAM-D01-LS15010031\xb9\xc9\xca\xd0\xd0\xdb\xc6\xf0" Mode="\xd5\xfd\xb3\xa3\xc4\xa3\xca\xbd" WorkMode="\xc9\xfa\xb2\xfa\xc4\xa3\xca\xbd" DevVersion="3.1.0.1280" DevType="PCC200" Remark="Remark" PMTag="FA" PMMainSN="NULL" RetCode="0" RetMsg="OK">Probe</CmdName>\n</HvCmdRespond>\n'
...
def sendBroadcastBack(addr):
    ...
    for i in range(1,2):
        sNew.sendto(tempStrBo %(i,i),addr)
